...
5. **Headless fallback:** phiên nền không gọi được subagent → tự thực hiện bước đó **theo đúng đặc tả `.Codex/agents/<tên>.md`** (cùng chuẩn, cùng định dạng) — không bỏ bước.

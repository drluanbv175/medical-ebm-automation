...
# CONSORT 2010 (25 muc -- RCT)
CONSORT_ITEMS = [
    ("Title", "1a", "Xac dinh la RCT trong tieu de"),
    ("Abstract", "1b",
     "Tom tat co cau truc ve thiet ke, phuong phap, ket qua, ket luan"),
    ("Background & Objectives", "2a", "Boi canh khoa hoc va giai thich ly do"),
    ("Objectives", "2b", "Muc tieu cu the hoac gia thuyet"),
    ("Trial design", "3a",
     "Mo ta thiet ke (song song, factorial...) va ty le phan bo"),
    ("Trial design changes", "3b",
     "Thay doi phuong phap sau khi bat dau thu nghiem"),
    ("Participants", "4a", "Tieu chi chon/loai nguoi tham gia"),
    ("Setting", "4b", "Boi canh, dia diem thu thap du lieu"),
    ("Interventions", "5",
     "Can thiep trong tung nhom; du chi tiet de tai lap"),
    ("Outcomes primary", "6a", "Ket cuc chinh va phu; cach do va thoi diem"),
    ("Outcomes changes", "6b",
     "Thay doi ket cuc sau khi bat dau thu nghiem"),
    ("Sample size", "7a", "Cach tinh co mau"),
    ("Interim analyses", "7b", "Phan tich trung gian va quy tac dung"),
    ("Randomisation sequence", "8a", "Phuong phap tao chuoi ngau nhien"),
    ("Randomisation type", "8b", "Loai phan ngau nhien; chi tiet han che"),
    ("Allocation concealment", "9", "Co che che giau phan bo"),
    ("Implementation", "10", "Ai tao chuoi, ai tuyen nguoi, ai phan bo"),
    ("Blinding", "11a",
     "Mu ai: nguoi tham gia, nguoi thuc hien, nguoi danh gia ket cuc"),
    ("Blinding similarity", "11b",
     "Neu lien quan, tuong dong cua can thiep"),
    ("Statistical methods", "12a",
     "Phuong phap thong ke so sanh nhom cho ket cuc chinh va phu"),
    ("Additional analyses", "12b",
     "Phuong phap phan tich them (phan nhom, hieu chinh)"),
    ("Participant flow", "13a",
     "So luong moi nhom duoc phan bo, nhan dieu tri, phan tich"),
    ("Recruitment", "14a", "Ngay va ly do dung thu nghiem"),
    ("Baseline data", "15", "Bang dac diem nen"),
    ("Outcomes and estimation", "17a",
     "Ket qua tung nhom, uoc luong hieu qua va do chinh xac"),
]
...
DESIGN_CHECKLIST_MAP = {
    "rct":             ("CONSORT 2010", CONSORT_ITEMS),

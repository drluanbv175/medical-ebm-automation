...
SPIRIT_2025_ITEMS: Tuple[Tuple[str, str, str], ...] = (
    ...
    ("9b", "Explanation for choice of comparator", "§3 · §6"),
    ("10", "Specific objectives related to benefits and harms", "§5"),
    ("11", "Details of, or plans for, patient or public involvement in the design, conduct, and reporting of the trial", "§6 (ghi rõ kế hoạch PPI)"),
    ("12", "Description of trial design including type of trial (eg, parallel group, crossover), allocation ratio, and framework (eg, superiority, equivalence, non-inferiority, exploratory)", "§6"),
    ("13", "Settings (eg, community, hospital) and locations (eg, countries, sites) where the trial will be conducted", "§6"),
    ...
    ("15a", "Intervention and comparator with sufficient details to allow replication including how, when, and by whom they will be administered. If relevant, where additional materials describing the intervention and comparator (eg, intervention manual) can be accessed", "§6 (mô tả theo TIDieR)"),
    ("15b", "Criteria for discontinuing or modifying allocated intervention/comparator for a trial participant (eg, drug dose change in response to harms, participant request, or improving/worsening disease)", "§6 · §14"),
    ("15c", "Strategies to improve adherence to intervention/comparator protocols, if applicable, and any procedures for monitoring adherence (eg, drug tablet return, sessions attended)", "§6 · §10"),
    ("15d", "Concomitant care that is permitted or prohibited during the trial", "§6"),
    ...
    ("18", "Time schedule of enrolment, interventions (including any run-ins and washouts), assessments, and visits for participants. A schematic diagram is highly recommended (see)", "§10 (sơ đồ lịch SPIRIT) · §6"),
    ...
    ("21a", "Who will generate the random allocation sequence and the method used", "§6"),
    ...
    ("22", "Mechanism used to implement the random allocation sequence (eg, central computer/telephone; sequentially numbered, opaque, sealed containers), describing any steps to conceal the sequence until interventions are assigned", "§6"),
    ("23", "Whether the personnel who will enrol and those who will assign participants to the interventions will have access to the random allocation sequence", "§6"),
    ("24a", "Who will be blinded after assignment to interventions (eg, participants, care providers, outcome assessors, data analysts)", "§6 · §14"),
    ("24b", "If blinded, how blinding will be achieved and description of the similarity of interventions", "§6 · §14"),
    ("24c", "If blinded, circumstances under which unblinding is permissible, and procedure for revealing a participant’s allocated intervention during the trial", "§6 · §15"),

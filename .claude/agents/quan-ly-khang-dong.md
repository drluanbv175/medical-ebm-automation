...
| M4 | Nguyên tắc chỉnh liều DOAC theo **CrCl (Cockcroft–Gault, KHÔNG eGFR) · cân nặng · tuổi · tương tác** cho dabigatran/rivaroxaban/edoxaban; **RIÊNG apixaban giảm liều theo ≥2/3 tiêu chí LÂM SÀNG (tuổi≥80·cân nặng≤60kg·creatinin≥1,5mg/dL), CrCl chỉ để loại trừ CrCl<15/lọc máu** (liều số cụ thể → `ke-don-an-toan`); **ĐÍCH INR** theo chỉ định cho VKA (ghi nguồn) |

...
description: Quản lý KHÁNG ĐÔNG chuyên sâu cho bệnh nhân ngoại trú — loại thuốc nguy cơ cao gặp thường xuyên nhất ở nội khoa ngoại trú (rung nhĩ không do van, thuyên tắc huyết khối tĩnh mạch VTE, van tim cơ học). Điều phối TRỌN VÒNG quyết định: cân nhắc chỉ định + nguy cơ huyết khối vs chảy máu (CHA₂DS₂-VASc/HAS-BLED qua thang-diem-nguy-co), CHỌN thuốc (VKA vs DOAC theo chỉ định — van cơ học/hẹp van 2 lá vừa-nặng/hội chứng kháng phospholipid → VKA), NGUYÊN TẮC chỉnh liều DOAC theo chức năng thận–cân nặng–tuổi–tương tác (liều cụ thể qua ke-don-an-toan, KHÔNG bịa số), ĐÍCH INR theo chỉ định, kế hoạch BẮC CẦU/ngưng quanh thủ thuật (periprocedural), ĐẢO NGƯỢC khi chảy máu, xử trí quên liều, giáo dục bệnh nhân, theo dõi. Dùng khi bác sĩ hỏi "chọn kháng đông nào", "liều DOAC theo eGFR", "bắc cầu quanh thủ thuật thế nào", "đảo ngược kháng đông khi chảy máu", "INR đích", "chuyển VKA↔DOAC". KHÔNG bịa liều/ngưỡng — dẫn guideline + năm; mọi kê/đổi thuốc qua ke-don-an-toan. Đề xuất điều trị dừng ở Cổng A. KHÔNG PII.
model: inherit
---

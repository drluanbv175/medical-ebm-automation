...
4. **Tính điểm — GỌI CÔNG CỤ (không tự cộng tay):**
   ...
   ```
   **CHỈ 8 thang trên có công cụ tính điểm THẬT** (điểm-cộng đơn giản/MELD công thức đơn — rủi ro sai công thức thấp). **ASCVD Pooled Cohort Equations · FRAX · SCORE2 · MELD-Na · NEWS2 CHƯA có công cụ** (ASCVD/FRAX/SCORE2/MELD-Na: hệ số hồi quy đa biến/độc quyền phức tạp; NEWS2 — SỬA 2026-07-22, vòng lặp kiểm tra-hoàn thiện vòng 8, phát hiện MEDIUM: nêu trong mô tả agent nhưng KHÔNG có nhánh tính ở đây, bảng điểm 7 thông số sinh tồn theo Royal College of Physicians dễ nhớ nhầm ngưỡng — nhớ nhầm 1 hệ số/ngưỡng cho kết quả sai không tự phát hiện được) → dùng máy tính CHÍNH THỐNG (MDCalc/RCP NEWS2 chart) hoặc gắn `[CẦN CÔNG CỤ CHÍNH THỐNG]`, KHÔNG tự nhẩm. Biến thiếu → tính kịch bản có/không + nêu khoảng (không gọi công cụ với giá trị bịa).

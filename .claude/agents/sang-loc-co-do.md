...
| **Sốt** | **qSOFA ≥2** (nhịp thở ≥22/phút · HA tâm thu ≤100 mmHg · rối loạn tri giác) → nghi nhiễm khuẩn huyết · cứng gáy + rối loạn tri giác (viêm màng não/não) · **ban xuất huyết** (não mô cầu) · sốt ở BN giảm bạch cầu hạt/hóa trị (neutropenic fever) · sốt + dấu thần kinh khu trú | qSOFA (Sepsis-3, Singer 2016, JAMA) · neutropenic fever (IDSA) | 🔴 sepsis/viêm màng não/neutropenic fever → cấy + kháng sinh sớm + chuyển cấp cứu; KHÔNG trì hoãn |

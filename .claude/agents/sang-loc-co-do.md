...
|---|---|---|---|
| **Khó thở** | SpO₂ thấp/tím · nói ngắt quãng từng từ · co kéo cơ hô hấp · tụt HA · đau ngực kèm theo · phù chân một bên (nghi DVT→PE) | Wells/PERC cho thuyên tắc phổi · ngưỡng SpO₂/tần số thở `[CẦN KIỂM CHỨNG theo guideline]` | 🔴 nếu suy hô hấp/sốc → O₂ + cấp cứu; loại trừ PE · phù phổi cấp · tràn khí MP áp lực · phản vệ · đợt cấp hen/COPD **NẶNG** (định nghĩa GINA/GOLD: chỉ nói được từng từ không trọn câu · dùng cơ hô hấp phụ/ngồi cúi ra trước · kích động · nhịp thở >30/phút · mạch >120/phút · SpO₂<90% — "nguy kịch" nếu lơ mơ/lú lẫn/"phổi im lặng") (vòng lặp kiểm tra-hoàn thiện vòng 5, 2026-07-21: trước đây "nặng" không định nghĩa cụ thể) |

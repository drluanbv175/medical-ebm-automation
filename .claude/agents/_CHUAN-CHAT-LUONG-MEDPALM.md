...
| **Q6. Tính cập nhật** *(mở rộng EBM)* | Nguồn dẫn so với guideline mới nhất; có bản cập nhật hơn không (nối `cap-nhat-guideline`) | Dựa khuyến cáo đã bị thay thế bởi guideline mới hơn mà không ghi nhận |
| **Q7. Thẩm quyền nguồn** *(mở rộng EBM)* | Phân hạng nguồn: guideline/SR-MA/RCT lớn/tạp chí uy tín ↔ nguồn yếu/**tạp chí săn mồi**/blog | Khẳng định trọng yếu chỉ dựa nguồn yếu/predatory mà không nêu giới hạn; hoặc trộn nguồn yếu ngang nguồn mạnh |

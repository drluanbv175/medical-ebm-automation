...
**🧭 LƯỚI AN TOÀN — GIÁ TRỊ NGUY KỊCH ĐỒNG THUẬN (chỉ dùng khi labo CHƯA cấu hình cờ).** CAVEAT: **ngưỡng của labo/đơn vị địa phương LUÔN ƯU TIÊN** — không có danh sách critical value thống nhất toàn cầu, ngưỡng dao động rộng giữa các viện (Howanitz, *Arch Pathol Lab Med* 2002, PMID 12033953; Kost, *Table of critical limits*, MLO 2003, PMID 12964300). Bảng dưới chỉ là **lưới chặn cuối** khi phiếu KQ không kèm cờ; số là khoảng xấp xỉ (có cờ/khoảng của phiếu thì theo phiếu); nghi nhiễu tiền phân tích (tán huyết→K⁺ giả tăng; garô lâu; mẫu cũ) → lặp lại.
...
| **Creatinin/AKI nặng** | KDIGO: ↑≥26.5 µmol/L (0.3 mg/dL)/48h, hoặc gđ3 ↑≥3× hoặc ≥353.6 µmol/L (4.0 mg/dL) `[CẦN KIỂM CHỨNG bản KDIGO]` | AKI nặng + tăng K⁺/quá tải dịch/toan → cân nhắc lọc máu cấp + chuyển |

...
3. Work down remaining `UI_PLACEHOLDER` items in `writeActionRegistry`: patient registration, appointment creation, patient care-plan draft, template draft, clinical rule draft and user invite.

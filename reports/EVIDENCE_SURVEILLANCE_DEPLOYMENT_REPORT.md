...
- Generated: `2026-09-13T04:08:45+00:00`
- Deployment status: `READY_FOR_CONTROLLED_DEPLOYMENT`
...
| ESD09 | Lịch sử runtime tuần/tháng | runtime | PASS | weekly:status=PASS,age=5.7d; monthly:status=PASS,age=11.7d | Cần ít nhất các lượt chạy thật còn mới; canary thủ công không thay lịch sử này. |
| ESD10 | Cấu hình kênh cảnh báo | runtime | PASS | email_ready=True; webhook_ready=False | Chỉ kiểm cấu hình có mặt, UAT vẫn phải chứng minh gửi/nhận thật. |
| ESD11 | UAT và phê duyệt | human | PASS | valid_source_samples=5; missing=[] | Đây là cổng người thật; agent chỉ kiểm bằng chứng, không tự ký hoặc tự điền PASS. |
